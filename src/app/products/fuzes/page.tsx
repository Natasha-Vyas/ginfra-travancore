...
export const metadata: Metadata = {
  ...
  description: 'Precision-engineered fuze systems for 23MM, 30MM, and 40MM ammunition. Point-detonating, proximity/timed, and programmable airburst fuzes for defense applications.',
  keywords: 'fuzes, fuze systems, point detonating fuzes, proximity fuzes, airburst fuzes, 23mm fuzes, 30mm fuzes, 40mm fuzes, defense fuzes',
  openGraph: {
    title: 'Fuzes | GInfra Travancore',
    description: 'Advanced fuze systems for defense applications',
    type: 'website',
  },
}
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="max-w-4xl mx-auto mb-8 animate-fade-in-up delay-300">
              <p className="text-lg md:text-xl text-gray-200 leading-relaxed mb-4">
                Partner with GInfra Travancore for precision fuze systems that exceed expectations.
