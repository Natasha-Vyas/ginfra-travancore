...
export const metadata: Metadata = {
  title: "All Products - GInfra Travancore | Defense Products - Fuzes, Cartridge Cases & PCBs",
  description: "Complete range of defense products including fuzes (23mm-40mm), cartridge cases (23mm-155mm), and defense-grade PCBs. Advanced ammunition components and electronic assemblies for military applications.",
  keywords: "defense products, fuzes, cartridge cases, PCBs, ammunition components, electronic assemblies, military products, defense electronics, artillery fuzes, combustible cartridge cases",
  openGraph: {
    title: "All Defense Products - GInfra Travancore",
    description: "Advanced defense products including fuzes, cartridge cases, and PCBs for military and aerospace applications.",
    url: "https://ginfratravancore.com/products/all",
    type: "website",
  },
  alternates: {
    canonical: "https://ginfratravancore.com/products/all",
  },
}
...
export default function AllProducts() {
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
          <div className="text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight animate-fade-in-up delay-200">
              ...
              <span className="text-xl md:text-3xl font-medium text-gray-300 ml-3">Products</span>
            </h1>
            <p className="text-lg md:text-xl mb-6 text-gray-200 max-w-3xl mx-auto leading-relaxed animate-fade-in-up delay-300">
              Precision-engineered <span className="text-blue-400 font-semibold hover:text-cyan-400 transition-colors duration-300">defense products</span> for mission-critical applications with superior performance and reliability.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-700 bg-clip-text text-transparent mb-4">What We Make</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We manufacture advanced defense products engineered for mission-critical applications, delivering precision, reliability, and superior performance for land, sea, and air platforms.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Fuzes */}
      <section id="fuzes" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Precision-engineered fuze solutions for 23mm, 30mm, and 40mm ammunition systems. Combat-proven reliability under extreme operational conditions with consistent functioning and accurate detonation.
              </p>
      ...
      {/* Cartridge Cases */}
      <section id="cartridge-cases" className="py-16 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      {/* PCBs */}
      <section id="pcbs" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center mb-6">
            ...
            <div className="bg-blue-50 p-8 rounded-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Multi-layer PCB Design (up to 32 layers)</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-blue-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
      ...
      <section id="capabilities" className="py-16 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-6">
              ...
              <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-700 bg-clip-text text-transparent">Product Capabilities</h2>
            </div>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Advanced manufacturing processes for high-performance defense products with exceptional precision and reliability.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="text-3xl font-bold text-cyan-600 mb-2">-55°C to +125°C</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li>• PCB assembly & testing</li>
                <li>• Environmental hardening</li>
                <li>• Fuze assembly & integration</li>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="max-w-4xl mx-auto mb-8 animate-fade-in-up delay-300">
              <p className="text-lg md:text-xl text-gray-200 leading-relaxed mb-4">
                Partner with GInfra Travancore for precision defense products that exceed expectations.
